...
gulp.task('flexslidercss', function(){
  gulp.src('app/sass/flexslider.css')
      .pipe(gulp.dest('./public/css'))
      .pipe($.livereload())
})
gulp.task('flexslidercss:build', ['flexslidercss'], function(){
  return gulp.src('app/css/flexslider.css')
    .pipe($.rev())
    .pipe(gulp.dest('./public/css'))
    .pipe($.rev.manifest())
    .pipe(gulp.dest('./public/css'))
...
gulp.task('flexslider', function(){
  gulp.src('app/js/jquery.flexslider.js')
      .pipe(gulp.dest('./public/js'))
      .pipe($.livereload())
})
gulp.task('flexslider:build', ['flexslider'], function(){
  return gulp.src('app/js/jquery.flexslider.js')
    .pipe($.rev())
    .pipe(gulp.dest('./public/js'))
    .pipe($.rev.manifest())
    .pipe(gulp.dest('./public/js'))
...
gulp.task('watch', function(){
  ...
  gulp.watch('app/sass/flexslider.css', ['flexslidercss'])
  gulp.watch('app/js/main.js', ['scripts'])
  gulp.watch('app/js/jquery.js', ['jquery'])
  gulp.watch('app/js/jquery.flexslider.js', ['flexslider'])
